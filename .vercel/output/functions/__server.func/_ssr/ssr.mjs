...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CGM3F61v.mjs");
...
var manifest = {
	...
	"e271323a77e71d3096f944cf1828bcbfd3ffbbec40ca9b0f9e18f73fc5fb9a76": {
		...
		importer: () => import("./match--3o0VLIb.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DlZ3myda.mjs").then((n) => n.t),
