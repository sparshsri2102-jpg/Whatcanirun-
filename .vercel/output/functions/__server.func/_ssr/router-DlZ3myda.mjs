...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DlZ3myda.js
var router_DlZ3myda_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Iy2hvmpS.css";
var APP_NAME = "can i run this";
var Route$5 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Paste your PC specs. Get the open-weight models that actually fit — download links, run commands, live Hugging Face drops, and GitHub agent skills."
			},
			{
				name: "theme-color",
				content: "#0a0a0a"
...
//#endregion
export { getRouter, router_DlZ3myda_exports as t };
