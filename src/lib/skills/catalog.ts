...
export const SKILLS: Skill[] = [
  {
    ...
    stars: 5200,
    description:
      "C-level advisory pack: positioning, campaign briefs, brand voice, funnel copy, and a marketing org in markdown.",
    tags: ["cmo", "marketing", "growth", "brand", "copy", "campaigns", "seo"],
    role: "CMO",
  },
  {
    ...
    tags: ["index", "catalog", "claude", "cursor", "codex"],
    role: "directory",
  },
  {
  ...
  },
  {
    ...
    tags: ["docs", "pdf", "xlsx", "pptx", "office"],
    role: "ops",
  },
  {
    id: "superpowers",
    ...
    tags: ["engineering", "tdd", "debug", "code-review"],
    role: "CTO",
  },
  {
    id: "frontend-design",
  ...
  },
  {
    ...
    tags: ["research", "analyst", "memo", "competitive"],
    role: "analyst",
  },
  {
    id: "product-manager",
    ...
    tags: ["pm", "product", "prd", "specs", "roadmap"],
    role: "PM",
  },
  {
    id: "cfo-finance",
    ...
    tags: ["cfo", "finance", "runway", "pricing"],
    role: "CFO",
  },
  {
    id: "legal-counsel",
    ...
    tags: ["legal", "contracts", "license", "privacy"],
    role: "counsel",
  },
  {
    id: "seo-content",
  ...
  },
  {
    ...
    tags: ["security", "owasp", "audit", "appsec"],
    role: "security",
  },
  {
    id: "qa-tester",
    ...
    tags: ["qa", "testing", "playwright", "regression"],
    role: "QA",
  },
  {
    id: "technical-writer",
  ...
  },
  {
    ...
    tags: ["hiring", "recruiter", "interview", "hr"],
    role: "recruiter",
  },
  {
    id: "customer-success",
    ...
    tags: ["cs", "success", "onboarding", "support"],
    role: "CS",
  },
  {
    id: "brand-designer",
    ...
    tags: ["brand", "design", "identity", "voice"],
    role: "brand",
  },
];

export function searchLocalSkills(query: string): Skill[] {
  ...
  return scored
    .filter((x) => x.n > 0)
    .sort((a, b) => b.n - a.n || b.s.stars - a.s.stars)
    .map((x) => x.s);
}
