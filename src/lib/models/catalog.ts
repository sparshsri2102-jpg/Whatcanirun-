...
const q = (
  rows: Array<[Model["quants"][number]["name"], number, number]>,
): Model["quants"] => rows.map(([name, vramGb, quality]) => ({ name, vramGb, quality }));
...
export const MODELS: Model[] = [
  {
    ...
    license: "Apache-2.0",
    contextK: 256,
    tasks: ["chat", "code", "reason", "vision", "agent"],
    summary:
  ...
  },
  {
    ...
    tasks: ["chat", "code", "reason", "agent"],
    summary:
      "Frontier-class MoE. 1-bit Unsloth GGUF ~93 GB; 3-bit wants ~120 GB unified. Not a 24 GB card model.",
    released: "2026-08",
  ...
  },
  {
    ...
    run: {
      llamacpp: "llama-cli -hf unsloth/GLM-5.3-GGUF:UD-IQ2_M",
    },
  ...
  },
  {
    ...
    run: {
      lmstudio: "ComfyUI + FLUX.1 dev fp8",
    },
    quality: 93,
  },
  {
    ...
    run: {
      lmstudio: "ComfyUI / Forge — SD3.5 Medium",
    },
    quality: 78,
  },
  {
  ...
  },
  {
    ...
    run: {
      lmstudio: "pip install kokoro; or use the HF space weights locally",
    },
    quality: 80,
  },
  {
...
export const PRESETS: Array<{
  ...
  label: string;
  hint: string;
  specs: Omit<import("./types").Specs, "source" | "raw">;
}> = [
  {
    id: "8gb-laptop",
    label: "8 GB laptop",
